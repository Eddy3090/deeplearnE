...
Description: 
Author: ZhangCheng
Date: 2021-12-14 11:18:08
LastEditors: ZhangCheng
LastEditTime: 2021-12-14 16:35:36
'''
import sys
...
def metric_A(inn, out):
    ...
    out_src = sorted(glob.glob(os.path.join(out,'*.png')))
    ...
    a = out_sum / in_sum
    print(in_sum, out_sum, a)
    return a

if __name__ == "__main__":
    input_dir = "/home/xm/project/temp/codeTry/DUTCode/results/Crowd/input"
    pred_dir = "/home/xm/project/temp/codeTry/DUTCode/results/Crowd/DUT"
    flow = metric_A(input_dir, pred_dir)
    x = 1